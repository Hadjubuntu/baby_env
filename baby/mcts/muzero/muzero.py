...
import baby.mcts.muzero.models as models
import baby.mcts.muzero.replay_buffer as replay_buffer
import baby.mcts.muzero.self_play as self_play
import baby.mcts.muzero.shared_storage as shared_storage
import baby.mcts.muzero.trainer as trainer
...
class MuZero:
    ...
    def __init__(self, game_name):
        ...
        try:
            game_module = importlib.import_module("baby.mcts.muzero.games." + self.game_name)
